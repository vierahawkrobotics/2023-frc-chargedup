...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    //   resetOdometry(lemonlight.getPose2d());
    // }
  }
  ...
  public Command pathGeneration(PathPoint intialPathPoint, PathPoint finalPathPoint) {
    ...
    PathPlannerTrajectory goToPoint = PathPlanner.generatePath(
    ...
    this.resetOdometry(goToPoint.getInitialPose());

    // Run path following command, then stop at the end.
    return swerveControllerCommand.andThen(() -> this.drive(0.0, 0.0, 0.0, false));
  }
}
