...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    new JoystickButton (joystick, 3).whileTrue(new AutoSetArmStateCommand(ArmStates.Low, armSubsystem, telescopeSubsystem, clawSubsystem));
  ...
  public Command getAutonomousCommand() {
    ...
    eventMap.put("RaiseArmToHigh", setState(ArmStates.Middle));
    eventMap.put("RaiseArmToLow", setState(ArmStates.Low));
    eventMap.put("RaiseArmToMid", setState(ArmStates.Middle));
    eventMap.put("LowerArmToGround",new SetArmStateCommand(ArmStates.Ground, armSubsystem, telescopeSubsystem));
